...
import com.sans.an.R;
import com.sans.an.model.BottomBar;
...
public class AppBottomBar extends BottomNavigationView {
    private static int[] sIcons = new int[]{R.drawable.icon_tab_message, R.drawable.icon_tab_file, R.drawable.icon_tab_auth, R.drawable.icon_tab_contact, R.drawable.icon_tab_discover};
